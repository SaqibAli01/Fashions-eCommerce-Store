...
const themeObj = {
    light: {
        ...
        background: {
            ...
            fotShadow: "rgba(255, 255, 255, 0.4) 0px -2px -4px, rgba(255, 255, 255, 0.3) 0px -7px -13px 3px, rgba(255, 255, 255, 0.2) 0px 3px 0px inset",
    ...
    dark: {
        ...
        background: {
            ...
            fotShadow: "0px -2px 4px rgba(192, 192, 192), 0px -7px 13px -3px rgba(192, 192, 191), 0px 3px 0px inset rgba(192, 192, 190)",
