...
import signUp, { forgotPassword, logout, resendOtpNo, resendVerificationCode, resetPassword, updatePassword, updateProfile, updateUserInfo, userAuth, userLogin, verifyCode, verifyCodePhoneNo, verifyEmail } from '../controllers/userController.js';
